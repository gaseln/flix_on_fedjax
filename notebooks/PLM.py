...
def create_train_for_each_client(grad_fn, client_optimizer):
  ...
  def client_step(client_step_state, batch):
    ...
    opt_state, params = client_optimizer.apply(grads, client_step_state['opt_state'], client_step_state['params'])
...
def computing_plm(
  ...
  def apply(
    ...
    for client_id, client_plm in train_for_each_client(server_state.params, batch_clients):
